...
function rollForTurn() {
    ...
    for (i=0;i<xArray.length;i++) {
        ...
        setTimeout(function() {writeMsg(txt1);}, 1000);  //maybe different syntax
    }
...
function check4Tie() {
    ...
    if(boardState.length >= 9 && check != "That's three in a row, Player 1 wins!" && chek != "That's three in a row, Player 1 wins!") {
        var txt1 = "Nobody wins, it was a tie!";
        tieSound();
        writeMsg(text1);
...
function Glowboard(pos) {
    ...
    for (var i=0;i<squares.length;i++) {
        if (i == index0) {
            ...
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(66, 179, 235)'}, 1000);
            ...
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(66, 179, 235)'}, 1000);
            ...
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(66, 179, 235)'}, 1000);
